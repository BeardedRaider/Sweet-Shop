<x-layout>
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" class="space-y-4 max-w-lg mx-auto bg-white p-6 rounded shadow">
        @csrf
        ...
        <div class="flex justify-between">
            ...
            <button type="submit" class="px-4 py-2 bg-pink-500 text-white rounded hover:bg-pink-600">Save Product</button>
        </div>
    </form>
</x-layout>
